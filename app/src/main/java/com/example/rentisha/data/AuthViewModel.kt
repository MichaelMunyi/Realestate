...
class AuthViewModel(var navController:NavHostController, var context:Context) {
    ...
    fun signup(name:String, email:String, password:String){
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener {
            ...
            var userProfile = com.example.rentisha.models.User(name, email, password, userId)
            ...
            usersRef.setValue(userProfile).addOnCompleteListener {
                ...
                if (it.isSuccessful){
                    ...
                    Toast.makeText(this.context, "Invalid login details", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    ...
    fun login(email: String, password: String){
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener {
            ...
            if (it.isSuccessful){
                ...
                Toast.makeText(this.context, "Sign up Error", Toast.LENGTH_SHORT).show()
            }
        }
    }
