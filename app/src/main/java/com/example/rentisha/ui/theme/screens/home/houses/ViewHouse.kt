package com.example.rentisha.ui.theme.screens.home.houses
...
import com.example.rentisha.data.HouseViewModel
...
fun ViewHouseScreen(navController:NavHostController) {
    Column(
        ...
        var productRepository = HouseViewModel(navController, context)
...
@Composable
fun ProductItem(
    name:String, location:String, price:String, id:String,
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Button(onClick = {
            productRepository.deleteHouse(id)
        }) {
            Text(text = "Delete")
        }
        Button(onClick = {
...
fun ViewProductsScreenPreview(){
   RentishaTheme {
        ViewHouseScreen(navController = rememberNavController())
    }
}